	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>Shivansi Das <h2><h4>Studied B.Tech in Computer Science and Engineering</h4>
							<h5>National Intitute of Science and Technology, Berhampur-760001.</h5>
						<p> 
							cell: +91 9348408697</p><br>
				</article>
			</div>
			<div class="col-md-6">
